	...
	<form method="post" action="" enctype="multipart/form-data">
		<div id="html-upload-ui">
			<p id="async-upload-wrap">
				...
				<p class="upload-html-bypass"><?php echo sprintf(__('<code>.xls</code> and <code>.csv</code> are the only acceptable formats. Please see <a href="%s">this image</a> to show a standard xls import file.', 'wp-sms'), plugins_url('jaiminho-sms/assets/images/standard-xml-file.png')); ?></p>
			</p>
